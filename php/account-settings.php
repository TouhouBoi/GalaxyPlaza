        ...
        <div class="post-list-outline">
            ...
            <form class="setting-form" action="/settings/account" method="post">
                ...
                <ul class="settings-list">
                    <li>
                        <p class="settings-label">Email Address / Gravatar Email Address</p>
                    ...
                    <li>
                        <p class="settings-label">Do you want every single Galaxy Plaza post to show up in your feed?</p>
                        <div class="select-content">
                            <div class="select-button">
