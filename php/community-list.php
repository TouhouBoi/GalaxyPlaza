    ...
    <div id="about">
        <div id="about-inner">
            <div id="about-text">
                ...
                <p><?php print(SITE_NAME); ?> is a Miiverse clone experience that lets you discuss whatever you want with friends and community members alike. It adds lots of features like a customizable post feed, a discovery panel, and the best community creation and search systems of any clone!</p>
