...
<html>
    <head>
        <title><?=$result->num_rows > 0 ? htmlspecialchars($row['nickname']) . '\'s post' : 'Error'?> - <?php print(SITE_NAME); ?></title>
        <link rel="stylesheet" href="/assets/css/embedded.css">
        <script src="/assets/js/inframe.min.js"></script>
    </head>
    <body>
        <div id="post-content">
            <a href="/" target="_blank"><img id="service-logo" src="/assets/img/menu-logo.png" alt="<?php print(SITE_NAME); ?>" width="165" height="30"></a>
            <?php
