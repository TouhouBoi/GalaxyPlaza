                ...
                if($result->num_rows === 0) {
                    ...
                    while($row = $result->fetch_assoc()) {
                        ...
                        if($row['type'] !== 5) {
                            ...
                            echo '<p class="title"><span class="nick-name">Galaxy Plaza Administration</span><span class="id-name">mvworld_admin</span></p><p class="text">You have received a notification from the administrators.</p>';
                        }
                        echo '</div></div>';
                    }
                }
